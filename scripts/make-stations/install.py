...
def main():
    ...
    time.sleep(2)
    os.system("sudo mkdir -p /var/lib/mpd/music/RADIO/_Stations/"+packCOUNTRY+"/"+packSTATE+"/"+packID+"/playlists/") 
    time.sleep(2)
    
    os.system("sudo cp ./stations-"+packCOUNTRY+"-"+packSTATE+"-"+packID+".m3u /var/lib/mpd/playlists/")
    os.system("sudo cp ./stations-"+packCOUNTRY+"-"+packSTATE+"-"+packID+".m3u /var/lib/mpd/music/RADIO/_Stations/"+packCOUNTRY+"/"+packSTATE+"/"+packID+"")
    os.system("sudo cp ./scanner-"+packCOUNTRY+"-"+packSTATE+"-"+packID+".m3u /var/lib/mpd/music/RADIO/_Stations/"+packCOUNTRY+"/"+packSTATE+"/"+packID+"")
    os.system("sudo cp ./logos/scanner-"+packCOUNTRY+"-"+packSTATE+"-"+packID+".jpg /var/www/images/radio-logos/thumbs")
    os.system("sudo cp ./logos/stations-"+packCOUNTRY+"-"+packSTATE+"-"+packID+".jpg /var/www/images/radio-logos/thumbs")
    os.system("sudo cp ./playlists/pls/*.pls /var/lib/mpd/music/RADIO/_Stations/"+packCOUNTRY+"/"+packSTATE+"/"+packID+"/playlists")
    
    print("\n\n[Installed: "+packID.upper()+"] Location: /var/lib/mpd/music/RADIO/_Stations/"+packCOUNTRY+"/"+packSTATE+"/"+packID+"\n\nEnjoy The Music!\n\n\n")
